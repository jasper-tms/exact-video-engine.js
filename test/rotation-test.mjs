// Drives test-rotation.html through the browser named by TEST_BROWSER (chromium,
// webkit, or firefox) for each rotation clip and asserts the engine's rendering
...
for (const file of ['plain.mp4', 'rot90.mp4', 'rot180.mp4', 'rot270.mp4']) {
  ...
  await page.goto(`${serverBase}/test/test-rotation.html?file=${file}`);
